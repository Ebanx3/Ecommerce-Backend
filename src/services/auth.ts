...
export const loginFunc = new Strategy({ usernameField:'email', passwordField:'password',passReqToCallback: true},login);
export const signupFunc = new Strategy({ usernameField:'email', passwordField:'password',passReqToCallback: true},signup);
